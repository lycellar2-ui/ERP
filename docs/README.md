...
| [bug-fix-lessons.md](./bug-fix-lessons.md) | 48 Rules rút ra từ 26 bugs — **PHẢI ĐỌC** trước khi code |
...
---
*Last updated: 2026-08-07 23:20 | Wine ERP v8.0 — 29 modules, 123 models, 77 enums, 42 action files, Pre-commit hook docs guardian, Docs Sync Protocol in GEMINI.md*
