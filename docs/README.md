...
| [bug-fix-lessons.md](./bug-fix-lessons.md) | 68 Rules rút ra từ 46 bugs — **PHẢI ĐỌC** trước khi code |
...
| **Connection Pool** | pgBouncer Transaction mode (port 6543), `max: 3` |
...
---
*Last updated: 2026-08-09 11:38 | Wine ERP v9.9.2 — Stock Count System Upgrade (Vintage tracking, Case+Bottle conversion, Multi-staff collaboration, Non-blocking warnings)*
