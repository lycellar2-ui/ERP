...
| **Cronjob Đồng Bộ Tự Động VNPT** | `src/app/api/cron/sync-vnpt/route.ts`, `vercel.json` | Chạy nền định kỳ mỗi 30 phút (khung giờ làm việc 8h - 19h VN) quét tối đa 50 hóa đơn nháp, tự động gọi VNPT lấy số HĐ chính thức, mã CQT, link PDF cho cả 2 pháp nhân TA & LC, tự động ghi Audit Log và làm mới cache. |
...
*Last updated: 2026-09-17 10:05 | Wine ERP v11.1*
