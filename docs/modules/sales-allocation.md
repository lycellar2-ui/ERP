...
| **Đa Pháp Nhân (Thắng Ân vs Ly's Cellar)** | `src/lib/vnpt/vnpt-client.ts:getVnptConfigForEntity` | Tách biệt cấu hình tài khoản, mẫu số và ký hiệu theo pháp nhân đơn hàng: Thắng Ân (`TA`: C26THP / 1/011) và Ly's Cellar (`LC`: C26TAB / 1/001). |
...
*Last updated: 2026-09-16 12:25 | Wine ERP v11.0*
