...
| **Tái thiết kế Sơ Đồ Kho 2D, Vẽ Tường/Cửa/Nhãn + Đổi Kích Thước Vùng/Kệ & Popup Tồn Kho** | `WarehouseMapTab.tsx`, `actions-map.ts` | Thay đổi tone màu Blueprint Slate hiện đại, hỗ trợ vẽ tường 🧱, cửa 🚪 (xoay 90°/180°), nhãn 🏷️, tẩy xóa 🧹. Thêm công cụ kéo thả góc vuông 📐 đổi kích thước (Rộng x Cao) từng vị trí/kệ, nhập số trực tiếp, mẫu chuẩn và đổi size hàng loạt cho tất cả các vị trí trong cùng Zone. Click vào vị trí để mở Popup Modal hiển thị tồn kho chi tiết (Lot, Vintage 🍷, SKU, Số lượng, Trạng thái) |
...
*Last updated: 2026-08-08 | Wine ERP v9.1 — 2D Warehouse Map Resizing & Zone Bulk Dimension Tools*
