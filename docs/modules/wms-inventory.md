...
| **Tái thiết kế Sơ Đồ Kho 2D & Công cụ Vẽ Tường/Cửa/Nhãn + Popup Tồn Kho** | `WarehouseMapTab.tsx`, `actions-map.ts` | Thay đổi tone màu Blueprint Slate hiện đại, hỗ trợ vẽ tường 🧱, cửa 🚪 (xoay 90°/180°), nhãn 🏷️, tẩy xóa 🧹. Click vào vị trí/kệ để mở Popup Modal hiển thị tồn kho chi tiết (Lot, Vintage 🍷, SKU, Số lượng, Trạng thái) |
...
*Last updated: 2026-08-08 | Wine ERP v9.0 — Architectural 2D Warehouse Map Redesign + Wall/Door Drawing & Lot Popup*
