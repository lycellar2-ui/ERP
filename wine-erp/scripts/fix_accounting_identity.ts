...
async function main() {
    ...
    console.log("🔍 Checking user in auth.users & auth.identities...");
    ...
    if (!users[0].identity_id) {
        console.log("⚠️ Identity missing for accounting@lyscellars.com! Creating auth.identities entry...");
    ...
    // Set working password hash `$2a$10$7BCklu26yGx29RISLC96NOHPXtPTh9tozLaprP0zt1QUck8SEDWAa`
    ...
    console.log("\n🧪 Testing signInWithPassword for accounting@lyscellars.com...");
    ...
    if (error) {
        ...
        console.log("🎉🎉🎉 SUCCESS! accounting@lyscellars.com AUTHENTICATED SUCCESSFULLY! User ID:", data.user.id);
    }
}
