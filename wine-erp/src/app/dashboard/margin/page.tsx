...
function MarginPageSkeleton() {
    return (
        <div className="space-y-6">
            <div className="h-16 rounded-xl animate-pulse" style={{ background: '#FFFFFF' }} />
            <div className="grid grid-cols-5 gap-3">
                {Array.from({ length: 5 }).map((_, i) => (
                    <div key={i} className="h-14 rounded-xl animate-pulse" style={{ background: '#FFFFFF' }} />
                ))}
            </div>
            <div className="h-12 rounded-xl animate-pulse" style={{ background: '#FFFFFF' }} />
            <div className="h-96 rounded-2xl animate-pulse" style={{ background: '#FFFFFF' }} />
        </div>
    )
}
