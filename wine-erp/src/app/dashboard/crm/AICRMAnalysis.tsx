        ...
        <div className="rounded-md overflow-hidden mb-5" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
            ...
            <div className="flex items-center justify-between px-5 py-3" style={{ borderBottom: '1px solid #E2E8F0' }}>
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold" style={{ color: '#0F172A' }}>AI CRM Analysis</h3>
                        <p className="text-[10px]" style={{ color: '#64748B' }}>Phân tích CRO — sức khỏe KH, churning, AR, chiến lược</p>
                    </div>
                </div>
            ...
            {!collapsed && <>
                    ...
                    <div className="px-5 pt-4">
                        ...
                        <div className="grid grid-cols-3 lg:grid-cols-6 gap-2 mb-3">
                            <div className="text-center p-2 rounded" style={{ background: '#FFFFFF' }}>
                                <div className="flex items-center justify-center gap-1 mb-0.5"><Users size={11} style={{ color: '#0891B2' }} /></div>
                                <p className="text-lg font-bold" style={{ color: '#0891B2' }}>{stats.totalCustomers}</p>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="flex items-center gap-3 p-2.5 rounded" style={{ background: '#FFFFFF' }}>
                                <span className="text-[10px] font-semibold uppercase tracking-wide" style={{ color: '#64748B' }}>Tiers:</span>
                ...
                {!analysis && !loading && !error && (
                    <div className="px-5 py-4 flex flex-col items-center gap-2">
                        <Users size={20} style={{ color: '#E2E8F0' }} />
