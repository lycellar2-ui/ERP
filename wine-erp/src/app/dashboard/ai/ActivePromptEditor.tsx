                    ...
                    if (!template) {
                        return (
                            <div key={slug} className="p-3 rounded-md flex items-center justify-between"
                                style={{ background: '#FFFFFF', border: '1px solid #1E3545' }}>
                        ...
                        <div key={slug} className="rounded-md overflow-hidden"
                            ...
                            <div className="flex items-center justify-between px-3 py-2.5 cursor-pointer"
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {isEditing ? <ChevronUp size={12} style={{ color: '#0891B2' }} /> : <ChevronDown size={12} style={{ color: '#64748B' }} />}
                                </div>
                            </div>
                            ...
                            {isEditing && (
                                <div className="px-3 pb-3 space-y-3 border-t" style={{ borderColor: '#1E3545' }}>
                                    <p className="text-[10px] pt-2" style={{ color: '#64748B' }}>{meta.desc}</p>
                                    ...
                                    <div>
                                        ...
                                        <textarea value={form.systemPrompt} rows={3}
                                            ...
                                            style={{ background: '#0F1D29', color: '#0F172A', border: '1px solid #E2E8F0', minHeight: '60px' }}
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea value={form.userTemplate} rows={12}
                                            ...
                                            className="w-full text-xs p-2.5 rounded-md resize-vertical font-mono"
                                            style={{ background: '#0F1D29', color: '#0F172A', border: '1px solid #E2E8F0', minHeight: '200px' }}
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="flex items-center gap-2">
                                            <label className="text-[10px] font-semibold" style={{ color: '#475569' }}>
                                            ...
                                            <input type="number" step="0.1" min="0" max="2" value={form.temperature}
                                                ...
                                                style={{ background: '#0F1D29', color: '#0F172A', border: '1px solid #E2E8F0' }}
                                            />
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <label className="text-[10px] font-semibold" style={{ color: '#475569' }}>
