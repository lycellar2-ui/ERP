                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <input type="number" value={addPrice} onChange={e => setAddPrice(e.target.value)} placeholder="VD: 1500000"
                                    className="w-full mt-1 px-3 py-2 text-sm outline-none" style={{ background: '#1B2E3D', border: '1px solid #2A4355', color: '#D4A853', fontFamily: 'var(--font-sans)', borderRadius: '6px' }} />
                            </div>
