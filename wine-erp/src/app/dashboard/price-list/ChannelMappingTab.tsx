        ...
        <div className="max-w-4xl space-y-6">
            <div className="p-6 rounded-lg space-y-6" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
                <div className="flex items-center gap-3 pb-3 border-b border-slate-200">
                    ...
                    <div>
                        <h3 className="text-base font-semibold" style={{ color: '#0F172A' }}>Ánh Xạ Kênh Giá Mặc Định</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-4 rounded-md space-y-2" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
                        ...
                        <p className="text-[11px] style={{ color: '#64748B' }}">Bảng giá áp dụng mặc định cho đại lý cấp 1, nhà phân phối</p>
                        <select
                            value={mapWholesale}
                    ...
                    <div className="p-4 rounded-md space-y-2" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
                        ...
                        <p className="text-[11px] style={{ color: '#64748B' }}">Bảng giá áp dụng cho khách hàng cá nhân thân thiết VIP</p>
                        <select
                            value={mapVip}
                    ...
                    {/* Direct Individual */}
                    <div className="p-4 rounded-md space-y-2" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
                        <label className="text-xs font-semibold uppercase tracking-wider block" style={{ color: '#475569' }}>
                            4. Kênh Mua Trực Tiếp (Khách Vãng Lai)
                        </label>
                        <p className="text-[11px] style={{ color: '#64748B' }}">Bảng giá niêm yết bán lẻ cho khách vãng lai, mua lẻ</p>
                        <select
                            value={mapDirect}
                ...
                <div className="pt-4 flex items-center justify-between">
                    <div>
                        {savedSuccess && (
                            <span className="inline-flex items-center gap-1.5 text-xs text-[#0891B2] font-medium">
