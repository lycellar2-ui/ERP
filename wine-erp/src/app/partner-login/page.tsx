                ...
                <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
                    {portalLoading ? (
                        ...
                        <>
                            {/* Shipments */}
                            <div>
                                <h2 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: '#0891B2' }}>
                                    <Ship size={14} className="inline mr-2" />
                                    Lô Hàng Được Phân Công ({shipments.length})
                                </h2>
                                {shipments.length === 0 ? (
                                    <div className="text-center py-12 rounded-lg" style={{ background: '#FFFFFF', border: '1px dashed #E2E8F0' }}>
                                        <p className="text-sm" style={{ color: '#64748B' }}>Chưa có lô hàng nào được phân công</p>
                                    </div>
                                ) : (
                            ...
                            <div>
                                ...
                                {submissions.length === 0 ? (
                                    <div className="text-center py-12 rounded-lg" style={{ background: '#FFFFFF', border: '1px dashed #E2E8F0' }}>
                                        <p className="text-sm" style={{ color: '#64748B' }}>Chưa có hồ sơ nào</p>
                                    </div>
                                ) : (
                                    <div className="rounded-lg overflow-hidden" style={{ border: '1px solid #E2E8F0' }}>
                                        <table className="w-full text-left" style={{ borderCollapse: 'collapse' }}>
                                                ...
                                                {submissions.map(s => {
                                                    ...
                                                    return (
                                                        <tr key={s.id} style={{ borderBottom: '1px solid rgba(42,67,85,0.5)' }}>
                                                            ...
                                                            <td className="px-4 py-3 text-xs" style={{ color: '#64748B' }}>{formatDate(s.reviewedAt)}</td>
                                                        </tr>
                                                    )
                                                })}
                                            </tbody>
        ...
        <div className="min-h-screen flex items-center justify-center" style={{ background: '#F8FAFC' }}>
            <div className="w-full max-w-sm space-y-6">
                ...
                <div className="text-center">
                    ...
                    <h1 className="text-2xl font-bold font-brand" style={{ color: '#0F172A' }}>
                        Partner Portal
                    </h1>
                ...
                <div className="p-6 rounded-xl space-y-4" style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                    ...
                    <div>
                        <label className="text-xs font-semibold uppercase tracking-wide block mb-1.5" style={{ color: '#64748B' }}>Mật Khẩu</label>
                        <input
                            type="password"
                            value={password}
